import {
  ...
  murmur2,
  serializeStyles
} from "./chunk-DDWA6I7P.js";
import {
  init_emotion_memoize_esm,
  memoize
} from "./chunk-L7LVLFFQ.js";
import {
...
var require_convert_source_map = __commonJS({
  "../node_modules/convert-source-map/index.js"(exports) {
    ...
    exports.fromJSON = function(json2) {
...
var require_find_root = __commonJS({
  "../node_modules/find-root/index.js"(exports, module) {
    var path = require_path();
    var fs = require_fs();
    function defaultCheck(dir) {
      return fs.existsSync(path.join(dir, "package.json"));
    }
    function findRoot2(start, check) {
      ...
      return findRoot2(start, check);
    }
    module.exports = findRoot2;
  }
});
...
var require_lowercase = __commonJS({
  "../node_modules/@babel/types/lib/builders/generated/lowercase.js"(exports) {
    ...
    function declareClass(id, typeParameters = null, _extends2 = null, body) {
      ...
      validate(defs.id, node, "id", id, 1);
      validate(defs.typeParameters, node, "typeParameters", typeParameters, 1);
      validate(defs.extends, node, "extends", _extends2, 1);
      validate(defs.body, node, "body", body, 1);
      return node;
    }
...
${frame}`;
    ...
    function index2(rawLines, lineNumber, colNumber, opts = {}) {
...
function _toArray(arr) {
  return _arrayWithHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray2(arr) || _nonIterableRest();
}
    ...
    Node = function() {
      ...
      _createClass(Node4, [{
        ...
        value: function toString() {
          var src = this.context.src, range = this.range, value2 = this.value;
  ...
  "../node_modules/yaml/browser/dist/parse-cst.js"() {
    ...
    CollectionItem = function(_Node) {
      ...
      _createClass(CollectionItem2, [{
        ...
        key: "toString",
        value: function toString() {
          var src = this.context.src, node = this.node, range = this.range, value2 = this.value;
          if (value2 != null) return value2;
    ...
    Collection = function(_Node) {
      ...
      _createClass(Collection3, [{
        ...
        key: "toString",
        value: function toString() {
          var src = this.context.src, items = this.items, range = this.range, value2 = this.value;
          if (value2 != null) return value2;
...
function toJSON(value2, arg, ctx) {
  if (Array.isArray(value2)) return value2.map(function(v, i) {
  ...
  if ((!ctx || !ctx.keep) && typeof value2 === "bigint") return Number(value2);
  return value2;
}
...
function singleQuotedString(value2, ctx) {
  if (ctx.implicitKey) {
    if (/\n/.test(value2)) return doubleQuotedString(value2, ctx);
  } else {
    if (/[ \t]\n|\n[ \t]/.test(value2)) return doubleQuotedString(value2, ctx);
  }
  var indent = ctx.indent || (containsDocumentMarker(value2) ? "  " : "");
...
function blockString(_ref2, ctx, onComment, onChompKeep) {
  var comment = _ref2.comment, type = _ref2.type, value2 = _ref2.value;
  ...
  var literal = type === Type.BLOCK_FOLDED ? false : type === Type.BLOCK_LITERAL ? true : !lineLengthOverLimit(value2, strOptions.fold.lineWidth, indent.length);
  var header = literal ? "|" : ">";
  if (!value2) return header + "\n";
  var wsStart = "";
  var wsEnd = "";
  value2 = value2.replace(/[\n\t ]*$/, function(ws) {
    ...
    if (n === -1) {
      header += "-";
    } else if (value2 === ws || n !== ws.length - 1) {
      header += "+";
  ...
  if (!value2) return "".concat(header).concat(indentSize, "\n").concat(indent).concat(wsEnd);
  if (literal) {
    value2 = value2.replace(/\n+/g, "$&".concat(indent));
...
function plainString(item, ctx, onComment, onChompKeep) {
  var comment = item.comment, type = item.type, value2 = item.value;
  ...
  if (!implicitKey && !inFlow && type !== Type.PLAIN && value2.indexOf("\n") !== -1) {
  ...
  if (actualString) {
    ...
    if (typeof resolved !== "string") return doubleQuotedString(value2, ctx);
  }
...
function stringifyString(item, ctx, onComment, onChompKeep) {
  ...
  var _item = item, type = _item.type, value2 = _item.value;
  if (typeof value2 !== "string") {
  ...
  if (type !== Type.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(value2)) {
...
function stringifyNumber(_ref) {
  ...
  if (!isFinite(value2)) return isNaN(value2) ? ".nan" : value2 < 0 ? "-.inf" : ".inf";
...
var init_resolveSeq_492ab440 = __esm({
  "../node_modules/yaml/browser/dist/resolveSeq-492ab440.js"() {
    ...
    Collection2 = function(_Node) {
      ...
      _createClass(Collection3, [{
        key: "addIn",
        value: function addIn(path, value2) {
          if (isEmptyPath(path)) this.add(value2);
          else {
            var _path = _toArray(path), key = _path[0], rest = _path.slice(1);
            var node = this.get(key, true);
            if (node instanceof Collection3) node.addIn(rest, value2);
            else if (node === void 0 && this.schema) this.set(key, collectionFromPath(this.schema, rest, value2));
        ...
        value: function setIn(_ref7, value2) {
          ...
          if (rest.length === 0) {
            ...
            var node = this.get(key, true);
            if (node instanceof Collection3) node.setIn(rest, value2);
            else if (node === void 0 && this.schema) this.set(key, collectionFromPath(this.schema, rest, value2));
            else throw new Error("Expected YAML collection at ".concat(key, ". Remaining path: ").concat(rest));
          }
        }
    ...
    Pair = function(_Node) {
      ...
      _createClass(Pair2, [{
        ...
        value: function toString(ctx, onComment, onChompKeep) {
          ...
          if (!explicitKey && !this.comment && value2 instanceof Scalar) ctx.indentAtStart = str.length + 1;
          chompKeep = false;
...
function createPairs(schema, iterable, ctx) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      var pair = schema.createPair(key, value2, ctx);
...
function createSet(schema, iterable, ctx) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      set2.items.push(schema.createPair(value2, null, ctx));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
  ...
  "../node_modules/yaml/browser/dist/warnings-df54cb69.js"() {
    ...
    binary = {
      ...
      stringify: function stringify(_ref, ctx, onComment, onChompKeep) {
        var comment = _ref.comment, type = _ref.type, value2 = _ref.value;
        var src;
        if (typeof Buffer === "function") {
        ...
        if (type === Type.QUOTE_DOUBLE) {
          ...
          value2 = lines.join(type === Type.BLOCK_LITERAL ? "\n" : " ");
        }
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              if (pair instanceof Pair) {
                ...
                value2 = toJSON(pair.value, key, ctx);
              } else {
                key = toJSON(pair, "", ctx);
              }
    ...
    YAMLSet = function(_YAMLMap) {
      ...
      _createClass(YAMLSet2, [{
        ...
        key: "set",
        value: function set2(key, value2) {
          if (typeof value2 !== "boolean") throw new Error("Expected boolean value for set(key, value) in a YAML set, not ".concat(_typeof(value2)));
    ...
    stringifySexagesimal = function stringifySexagesimal2(_ref) {
      ...
      if (isNaN(value2) || !isFinite(value2)) return stringifyNumber(value2);
      var sign = "";
      if (value2 < 0) {
        sign = "-";
  ...
  if (obj instanceof Map) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        ...
        map2.items.push(schema.createPair(key, value2, ctx));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
function intStringify$1(node, radix, prefix) {
  ...
  if (intIdentify$2(value2) && value2 >= 0) return prefix + value2.toString(radix);
...
function createNode4(value2, tagName, ctx) {
  if (value2 instanceof Node2) return value2;
  ...
  if (!tagObj) {
    if (typeof value2.toJSON === "function") value2 = value2.toJSON();
    if (!value2 || _typeof(value2) !== "object") return wrapScalars ? new Scalar(value2) : value2;
  ...
  "../node_modules/yaml/browser/dist/index.js"() {
    ...
    Document$1 = function() {
      ...
      _createClass(Document3, [{
        ...
        key: "setIn",
        value: function setIn(path, value2) {
          if (isEmptyPath(path)) this.contents = value2;
          else {
            assertCollection(this.contents);
...
var require_dist2 = __commonJS({
  "../node_modules/babel-plugin-macros/dist/index.js"(exports, module) {
    ...
    function createMacro2(macro, options = {}) {
...
var import_find_root = __toESM(require_find_root());
init_emotion_memoize_esm();
...
var import_babel_plugin_macros = __toESM(require_dist2());
var invalidClassNameCharacters = /[!"#$%&'()*+,./:;<=>?@[\]^`|}~{]/g;
var sanitizeLabelPart = function sanitizeLabelPart2(labelPart) {
...
function getLabel(identifierName, labelFormat, filename) {
  ...
  var parsedPath = import_path.default.parse(filename);
  var localDirname = import_path.default.basename(parsedPath.dir);
...
var getObjPropertyLikeName = function getObjPropertyLikeName2(path, t) {
...
function getSourceMap(offset, state) {
  ...
  if (generatorOpts.sourceFileName && generatorOpts.sourceFileName !== "unknown") {
    ...
    return import_convert_source_map.default.fromObject(generator).toComment({
      multiline: true
    });
  }
  return "";
}
var hashArray = function hashArray2(arr) {
  return murmur2(arr.join(""));
};
var unsafeRequire = __require;
var getPackageRootPath = memoize(function(filename) {
  return (0, import_find_root.default)(filename);
});
var separator = new RegExp((0, import_escape_string_regexp.default)(import_path.default.sep), "g");
var normalizePath = function normalizePath2(path) {
  return import_path.default.normalize(path).replace(separator, "/");
};
function getTargetClassName(state, t) {
  if (state.emotionTargetClassNameCount === void 0) {
    state.emotionTargetClassNameCount = 0;
  }
  var hasFilepath = state.file.opts.filename && state.file.opts.filename !== "unknown";
  var filename = hasFilepath ? state.file.opts.filename : "";
  var moduleName = "";
...
function simplifyObject(node, t) {
  ...
  for (var i = 0; i < node.properties.length; i++) {
    ...
    var value2 = property.value.value;
    finalString += serializeStyles([(_ref = {}, _ref[key] = value2, _ref)]).styles;
  }
  return t.stringLiteral(finalString);
}
var haveSameLocation = function haveSameLocation2(element1, element2) {
  return element1.line === element2.line && element1.column === element2.column;
};
var isAutoInsertedRule = function isAutoInsertedRule2(element) {
  return element.type === "rule" && element.parent && haveSameLocation(element, element.parent);
};
var toInputTree = function toInputTree2(elements, tree) {
  for (var i = 0; i < elements.length; i++) {
    var element = elements[i];
    var parent = element.parent, children = element.children;
    if (!parent) {
      tree.push(element);
    ...
    if (Array.isArray(children)) {
      element.children = [];
      toInputTree2(children, tree);
    }
  }
  return tree;
};
var stringifyTree = function stringifyTree2(elements) {
  return elements.map(function(element) {
    switch (element.type) {
      ...
      case "rule":
        return element.value.replace(/&\f/g, "&") + "{" + stringifyTree2(element.children) + "}";
      default: {
        return element.value + "{" + stringifyTree2(element.children) + "}";
      }
    }
  }).join("");
};
var interleave = function interleave2(strings, interpolations) {
...
function replacePlaceholdersWithExpressions(str, expressions, t) {
  ...
  matches.forEach(function(_ref, i) {
    var value2 = _ref.value, p1 = _ref.p1, index2 = _ref.index;
    var preMatch = str.substring(cursor, index2);
    cursor = cursor + preMatch.length + value2.length;
    if (!preMatch && i === 0) {
    ...
    if (i === matches.length - 1) {
      strings.push(t.stringLiteral(str.substring(index2 + value2.length)));
    }
  });
...
var appendStringReturningExpressionToArguments = function appendStringReturningExpressionToArguments2(t, path, expression) {
...
var joinStringLiterals = function joinStringLiterals2(expressions, t) {
...
var transformExpressionWithStyles = function transformExpressionWithStyles2(_ref) {
  var babel = _ref.babel, state = _ref.state, path = _ref.path, shouldLabel = _ref.shouldLabel, _ref$sourceMap = _ref.sourceMap, sourceMap = _ref$sourceMap === void 0 ? "" : _ref$sourceMap;
  var autoLabel = state.opts.autoLabel || "dev-only";
  var t = babel.types;
  if (t.isTaggedTemplateExpression(path)) {
    if (!sourceMap && state.emotionSourceMap && path.node.quasi.loc !== void 0) {
  ...
  if (t.isCallExpression(path)) {
    ...
    if (!sourceMap && canAppendStrings && state.emotionSourceMap && path.node.loc !== void 0) {
...
var getKnownProperties = function getKnownProperties2(t, node) {
...
var createObjectSpreadLike = function createObjectSpreadLike2(t, file) {
...
var getStyledOptions = function getStyledOptions2(t, path, state) {
  var autoLabel = state.opts.autoLabel || "dev-only";
  var args = path.node.arguments;
  var optionsArgument = args.length >= 2 ? args[1] : null;
  var prodProperties = [];
  var devProperties = null;
  var knownProperties = optionsArgument && t.isObjectExpression(optionsArgument) ? getKnownProperties(t, optionsArgument) : /* @__PURE__ */ new Set();
...
function addImport(state, importSource, importedSpecifier, nameHint) {
  ...
  if (state[cacheKey] === void 0) {
    var importIdentifier;
    if (importedSpecifier === "default") {
      importIdentifier = (0, import_helper_module_imports.addDefault)(state.file.path, importSource, {
        nameHint
      });
    } else {
      importIdentifier = (0, import_helper_module_imports.addNamed)(state.file.path, importedSpecifier, importSource, {
        nameHint
      });
    }
...
function createTransformerMacro(transformers2, _ref) {
  var importSource = _ref.importSource;
  var macro = (0, import_babel_plugin_macros.createMacro)(function(_ref2) {
    ...
    Object.keys(references).forEach(function(importSpecifierName) {
      if (transformers2[importSpecifierName]) {
        references[importSpecifierName].reverse().forEach(function(reference) {
          var options;
          var transformer;
          if (Array.isArray(transformers2[importSpecifierName])) {
            transformer = transformers2[importSpecifierName][0];
            options = transformers2[importSpecifierName][1];
          } else {
            transformer = transformers2[importSpecifierName];
            options = {};
          }
          transformer({
            state,
  ...
  macro.transformers = transformers2;
  return macro;
}
var isAlreadyTranspiled = function isAlreadyTranspiled2(path) {
...
var createEmotionTransformer = function createEmotionTransformer2(isPure) {
  return function(_ref) {
    var state = _ref.state, babel = _ref.babel;
    _ref.importSource;
...
var createEmotionMacro = function createEmotionMacro2(importSource) {
  return createTransformerMacro(transformers$1, {
    importSource
  });
};
var getReferencedSpecifier = function getReferencedSpecifier2(path, specifierName) {
...
var styledTransformer = function styledTransformer2(_ref) {
  var state = _ref.state, babel = _ref.babel, path = _ref.path, importSource = _ref.importSource, reference = _ref.reference, importSpecifierName = _ref.importSpecifierName, _ref$options = _ref.options, styledBaseImport = _ref$options.styledBaseImport, isWeb = _ref$options.isWeb;
  var t = babel.types;
  var getStyledIdentifier = function getStyledIdentifier2() {
...
var createStyledMacro = function createStyledMacro2(_ref2) {
  var importSource = _ref2.importSource, _ref2$originalImportS = _ref2.originalImportSource, originalImportSource = _ref2$originalImportS === void 0 ? importSource : _ref2$originalImportS, _ref2$baseImportName = _ref2.baseImportName, baseImportName = _ref2$baseImportName === void 0 ? "default" : _ref2$baseImportName, isWeb = _ref2.isWeb;
...
var transformCssCallExpression = function transformCssCallExpression2(_ref) {
  var state = _ref.state, babel = _ref.babel, path = _ref.path, sourceMap = _ref.sourceMap, _ref$annotateAsPure = _ref.annotateAsPure, annotateAsPure = _ref$annotateAsPure === void 0 ? true : _ref$annotateAsPure;
  var node = transformExpressionWithStyles({
    babel,
    state,
    path,
...
var transformCsslessArrayExpression = function transformCsslessArrayExpression2(_ref2) {
  var state = _ref2.state, babel = _ref2.babel, path = _ref2.path;
  var t = babel.types;
  var expressionPath = path.get("value.expression");
  var sourceMap = state.emotionSourceMap && path.node.loc !== void 0 ? getSourceMap(path.node.loc.start, state) : "";
...
var transformCsslessObjectExpression = function transformCsslessObjectExpression2(_ref3) {
  var state = _ref3.state, babel = _ref3.babel, path = _ref3.path, cssImport = _ref3.cssImport;
  var t = babel.types;
  var expressionPath = path.get("value.expression");
  var sourceMap = state.emotionSourceMap && path.node.loc !== void 0 ? getSourceMap(path.node.loc.start, state) : "";
  expressionPath.replaceWith(t.callExpression(
...
var cssTransformer = function cssTransformer2(_ref4) {
...
var globalTransformer = function globalTransformer2(_ref5) {
  var state = _ref5.state, babel = _ref5.babel, reference = _ref5.reference, importSource = _ref5.importSource, options = _ref5.options;
  var t = babel.types;
  ...
  if (t.isJSXExpressionContainer(stylesPropPath.node.value)) {
    if (t.isArrayExpression(stylesPropPath.node.value.expression)) {
      ...
      transformCsslessObjectExpression({
        ...
        babel,
        path: stylesPropPath,
        cssImport: options.cssExport !== void 0 ? {
          importSource,
...
var getCssExport = function getCssExport2(reexported, importSource, mapping) {
...
function index(babel, options) {
  if (options.autoLabel !== void 0 && !AUTO_LABEL_VALUES.includes(options.autoLabel)) {
    ...
    visitor: {
      ImportDeclaration: function ImportDeclaration(path, state) {
        ...
        var referencePathsByImportName = imports.reduce(function(byName, _ref) {
          var importedName = _ref.importedName, localName = _ref.localName;
      ...
      Program: function Program(path, state) {
        ...
        Object.keys(state.opts.importMap || {}).forEach(function(importSource) {
          var value2 = state.opts.importMap[importSource];
          var transformers2 = {};
          Object.keys(value2).forEach(function(localExportName) {
            var _value$localExportNam = value2[localExportName], canonicalImport = _value$localExportNam.canonicalImport, options2 = _objectWithoutPropertiesLoose(_value$localExportNam, _excluded);
            var packageName = canonicalImport[0], exportName = canonicalImport[1];
            if (packageName === "@emotion/react" && exportName === "jsx") {
              jsxReactImports.push({
                importSource,
                "export": localExportName,
                cssExport: getCssExport("jsx", importSource, value2)
              });
              return;
            }
            var packageTransformers = transformersSource[packageName];
            if (packageTransformers === void 0) {
            ...
            if (packageName === "@emotion/react" && exportName === "Global") {
              extraOptions = {
                cssExport: getCssExport("Global", importSource, value2)
              };
            ...
            var _ref2 = Array.isArray(packageTransformers[exportName]) ? packageTransformers[exportName] : [packageTransformers[exportName]], exportTransformer = _ref2[0], defaultOptions2 = _ref2[1];
            transformers2[localExportName] = [exportTransformer, _extends({}, defaultOptions2, extraOptions, options2)];
          });
          macros2[importSource] = createTransformerMacro(transformers2, {
            importSource
          });
        });
...
//# sourceMappingURL=@emotion_babel-plugin.js.map
